...
public class PersonRepository {
    ...
    private final Connection connection = connectionDB.connection();
    ...
    private final String CREATE_TABLE = "create table person(id serial primary key, name varchar, age varchar)";
